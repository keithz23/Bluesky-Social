            ...
            <div className="relative min-w-0 flex-1 pt-1">
              <div className="relative min-h-32 min-w-0">
                <textarea
                  ...
                  className="max-h-56 min-h-32 w-full resize-none overflow-x-hidden overflow-y-auto whitespace-pre-wrap break-words border-none bg-transparent text-[17px] leading-6 text-slate-950 caret-slate-950 outline-none [overflow-wrap:anywhere] placeholder:text-slate-400 focus:ring-0"
