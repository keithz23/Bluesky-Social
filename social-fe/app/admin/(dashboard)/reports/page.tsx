...
export default function ReportsPage() {
  ...
  const canResolve = useAuthStore((state) =>
    state.permissions.includes("report:resolve"),
  );
    ...
    () => [
      ...
      },
      {
        ...
        cell: (report: AdminReport) => (
          <div>
            ...
            <p className="text-xs text-slate-500">{report.rule.severity}</p>
          </div>
        ),
      },
      {
      ...
      },
      {
        ...
        cell: (report) => (
          <Badge
            variant="outline"
            className={statusClass[report.status as ReportStatus]}
          >
            {report.status}
          </Badge>
        ),
        ...
        ? [
            {
              ...
              cell: (report: AdminReport) => (
                <Select
                  ...
                  onValueChange={(nextStatus: ReportStatus) =>
      ...
      <div className="mb-5 flex shrink-0 flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          <h1 className="flex items-center gap-2 text-2xl font-bold text-gray-900">
            <Flag className="size-6 text-blue-600" /> Reports
          </h1>
          <p className="mt-1 text-sm text-gray-500">
            Track every community and automated report.
          </p>
        </div>
        <p className="text-sm text-slate-500">
          {meta.total.toLocaleString()} reports
        </p>
      </div>
