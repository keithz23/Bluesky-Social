...
export default function ListDetailPage() {
  ...
  return (
    <div className="flex min-h-[calc(100dvh-7rem)] flex-col bg-white pb-20 lg:min-h-[calc(100dvh-3.5rem)]">
      <div className="sticky top-28 z-20 h-14 bg-white/90 backdrop-blur-md flex items-center justify-between px-4 lg:top-14">
        <button
          onClick={() => router.back()}
